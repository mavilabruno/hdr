...
{
    'name': 'MercadoPago Perú Payment Acquirer',
    'category': 'Accounting/Payment Acquirers',
    'sequence': 365,
    'summary': 'Payment Acquirer: MercadoPago Perú Implementation',
    'version': '15.1.22.1',
    'description': """MercadoPago Perú Payment Acquirer""",
    ...
    'images': ['src/img/mercadopago_icon.png','src/img/mercadopago_logo.png',
                ...
                'static/description/payment_mercadopago_pe_screenshot.png','static/description/main_screenshot.png',
